...
app = FastAPI(
    title="LoRA Training Studio API",
    description=(
        "End-to-end LoRA fine-tuning workflow — dataset, captions, training, "
        "samples, and the final .safetensors — all persisted on Backblaze B2."
    ),
    version="0.1.0",
    lifespan=lifespan,
)
